...
cameras             = fix_homogeneous_scale( cameras             );
cameras_test        = fix_homogeneous_scale( cameras_test        );
camera_centers      = fix_homogeneous_scale( camera_centers      );
camera_centers_test = fix_homogeneous_scale( camera_centers_test );
